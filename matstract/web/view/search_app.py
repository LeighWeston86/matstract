...
def get_search_results(search=None, material=None, max_results=1001):
    if search is None and material is None:
        return None
    else:
        ...
        if material is not None:
            ...
            results = search_engine.get_abstracts_by_material(material, ids=ids)
        else:
